...
function devolverUltimoElemento(array) {
  ...
  // Tu código:
  var utlimo = array[array.length - 1]; 
  return utlimo;
}
...
function numeroMasGrande(numeros) {
  ...
  return mayor;
  // let numeroMaxim = Math.max.apply(null, numeros);
  // return numeroMaxim;
...
function multiplicarArgumentos() {
  ...
  var  producto = 1;
  //cero para sumar y 1 para multiplicar
...
function diaDeLaSemana(numeroDeDia) {
  ...
  //Escribe tu código aquí   
  // 1 = Domingo, 2 = Lunes, 3 = Martes, 4 = Mercoles, 5 = Jueves, 6 = viernes, 7 = Sábado
